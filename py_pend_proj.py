...
surf_height = 720
num_pendula = 2
g = [0.8]				#this is a list because we need to reference it later (modify from somewhere else)
FPS = 60
...
counter = 0
def main():
    global pl,accs,g,num_pendula,trail_length,DISPLAYSURF,surf_width,surf_height,PDE_method
    ...
    game_gui = Gui(pl,num_pendula,g,trail_length,PDE_method)
