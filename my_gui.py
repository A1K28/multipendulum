...
class Gui(object):
	def __init__(self,pl,num_pendula,g,trail_length,PDE_method):
		...
		self.sliders[0] = [Slider([10,5+(i+3)*30],[80,250],pl[i].length, str("length - " + str(i+1))) for i in range(self.num_pendula)]
